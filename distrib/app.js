...
(function initPilotId() {
  ...
  if (pilotParam) {
    // QR Code scanné — mémoriser le pilote et forcer le rattachement
    const oldPilot = localStorage.getItem('pilot_id');
    if (oldPilot !== pilotParam) {
      // Nouveau pilote — réinitialiser le flag de rattachement
